        ...
        for (Cliente cliente : this.clientes) {
            ...
            switch (tipodeChave) {
                case DadosChavesPix.TELEFONE:
                    chavePix = contaCliente.getCHAVES_PIX().getTelefone();
                    break;
                case DadosChavesPix.EMAIL:
                    chavePix = contaCliente.getCHAVES_PIX().getEmail();
                    break;
                case DadosChavesPix.IDENTIFICACAO:
                    chavePix = contaCliente.getCHAVES_PIX().getIdentificacao();
                    break;
                case DadosChavesPix.CHAVE_ALEATORIA:
                    chavePix = contaCliente.getCHAVES_PIX().getChaveAleatoria();
                    break;
            }
